        ...
        <>
          ...
          >
            <div className="menu-items">
              <ul>
                <li>
                  <Link to="/ski" onClick={handleLinkClick}>
                    Ski
                  </Link>
                </li>
                <li>
                  <Link to="/snowboard" onClick={handleLinkClick}>
                    Snowboard
                  </Link>
                </li>
                <li>
                  <Link to="/jackets" onClick={handleLinkClick}>
                    Jackets
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/boots" onClick={handleLinkClick}>
                    Boots
                  </Link>
                </li>
                <li>
                  <Link to="/helmets" onClick={handleLinkClick}>
                    Helmets
                  </Link>
                </li>
                <li>
                  <Link to="/goggles" onClick={handleLinkClick}>
                    Goggles
                  </Link>
                </li>
                <li>
                  <Link to="/gloves" onClick={handleLinkClick}>
                    Gloves
                  </Link>
                </li>
                {loggedInUser ? (
        ...
        <>
          <div className="menu">
            <ul className="menu-items-center">
              ...
              <li>
                <Link to="/snowboard">Snowboard</Link>
              </li>
              <li>
