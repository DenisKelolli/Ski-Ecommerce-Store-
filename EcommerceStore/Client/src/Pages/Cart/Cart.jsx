...
const Cart = () => {
  ...
  useEffect(() => {
    const fetchCartItems = async () => {
      try {
        const response =  await axios.get(`${import.meta.env.VITE_API}/cart`, { withCredentials: true });
  ...
  const updateQuantity = async (productId, newQuantity) => {
    try {
      await axios.put(`${import.meta.env.VITE_API}/cart/${productId}`, { quantity: newQuantity }, { withCredentials: true });
  ...
  const deleteProduct = async (productId) => {
    try {
      await axios.delete(`${import.meta.env.VITE_API}/cart/${productId}`, {withCredentials: true,});
